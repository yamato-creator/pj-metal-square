...
# デフォルトはローカル開発用
origins = os.environ.get("CORS_ORIGINS", "http://localhost:3000,https://nippongoldmarket.com,https://www.nippongoldmarket.com,https://api.nippongoldmarket.com").split(",")
